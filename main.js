...
for (var Timeline_Btn_Index = 0; Timeline_Btn_Index < All_Timeline_Btns.length; Timeline_Btn_Index++)
{
...
let Correct_Answers_Array = ["Six", "East-West Line", "More than 160 stations", "Cash", "AMK Hub"]; // Add more answers if you have more questions
    ...
    Restart_Button.addEventListener('click', function()
   	{
		...
		Player_Name_And_Score = `User: <strong>${Player_Name}</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Score: ${Score} / 5`;
		Restart_Quiz();
	});
}
...
function Load_Game_Station_Page() {
	...
	ctx.restore(); // back to normal scale
}
